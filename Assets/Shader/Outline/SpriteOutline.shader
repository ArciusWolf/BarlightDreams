...
half4 CombinedShapeLightFragment(Varyings i) : SV_Target
{
    ...
    if (main.a == 0)
    {
        ...
        alpha += SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.uv + float2(texelSize.x * _OutlineSize, 0)).a;
        alpha += SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.uv - float2(texelSize.x * _OutlineSize, 0)).a;
        alpha += SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.uv + float2(0, texelSize.y * _OutlineSize)).a;
        alpha += SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, i.uv - float2(0, texelSize.y * _OutlineSize)).a;
